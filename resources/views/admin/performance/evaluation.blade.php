                ...
                "createdCell": function (td, cellData, rowData, row, col) {
                    if(rowData.eval_date !='no'){
                        if(rowData.manager_id == 0 && rowData.employee_id == 0){
                            if(rowData.status==2){
                                html = '<a href="{{url('admin/edit_evaluation/')}}/'+cellData+'"><input class="btn btn-info" type="button" value="ReEvaluate"></a>'
                            }else{
                                html = '<a href="{{url('admin/edit_evaluation/')}}/'+cellData+'"><input class="btn btn-info" type="button" value="Evaluate"></a>'
                            }
                        }else{
                            if(rowData.status==2){
                                html = '<a href="{{url('admin/edit_evaluation/')}}/'+cellData+'"><input class="btn btn-info" type="button" value="ReEvaluate"></a>'
