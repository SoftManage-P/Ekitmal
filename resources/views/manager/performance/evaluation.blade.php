    ...
    $(document).ready(function() {
        ...
        var datatable = $table.dataTable({
                ...
                "ajax": {
                    "type": "POST",
                    "async": true,
                    "url": '{{url("/manager/evaluation_list")}}',
                    "data": {},
                    "dataSrc": "data",
                    "dataType": "json",
                    "cache": false,
                ...
                },
                   {
                    ...
                    "createdCell": function (td, cellData, rowData, row, col) {
                        ...
                        if(rowData.eval_date !='no'){
                            if(rowData.employee_id == 0){
                               if(rowData.status==1){
                                    html = '<a href="{{url('manager/edit_evaluation/')}}/'+cellData+'"><input class="btn btn-info" type="button" value="ReEvaluate"></a>'
                                }else if(rowData.status==''||rowData.status==null){
                                     html = '<a href="{{url('manager/edit_evaluation/')}}/'+cellData+'"><input class="btn btn-info" type="button" value="Evaluate"></a>'
                                }else html = '<input class="btn btn-secondary waves-effect" type="button" value="Evaluate">' 
                            } else{
                                if(rowData.status==1){
                                    html = '<a href="{{url('manager/edit_evaluation/')}}/'+cellData+'"><input class="btn btn-info" type="button" value="ReEvaluate"></a>'
